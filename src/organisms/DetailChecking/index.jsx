...
const DetailChekingOrganism =({id}) =>{
    ...
    if (jwt.result.id_hotel == 7 || jwt.result.id_hotel == 3 || jwt.result.id_hotel == 4 || jwt.result.id_hotel == 23 || jwt.result.id_hotel == 5 || jwt.result.id_hotel == 6 || jwt.result.id_hotel == 12 || jwt.result.id_hotel == 13  ) {
        totalId = true;
    }
