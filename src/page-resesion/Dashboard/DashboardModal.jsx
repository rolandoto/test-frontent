            ...
            return (
                <div className="App-new"> 
                    <Pdf targetRef={ref} x={50} filename="code-example.pdf" >
                                                                {({ toPdf }) => <button onClick={toPdf}>Descargar comprobante</button>}
                                                                </Pdf>
                <div className="App-new" ref={ref}>
                ...
                <div>
                  <div>
                    <span className="container-pdf-title" >X14A-{resultHuespe?.Num_documento}</span>
                  </div>
          
                  <div>
                    <h2>
                      <span className="span-realizar" >Realiza</span>: {resultHuespe?.Nombre} {resultHuespe?.Apellido} 
                    </h2>
                  </div>
                </div>
                ...
                <div>
                  <div className="container-parrafo">
                    <span className="parrafo">Habitacion:{findRoomOne?.nombre},Adultos:{change?.adultos?change.adultos:change?.adultos},Niños:{change?.niños?change.niños :0},Infantes{change?.infantes ?change?.infantes:0}</span>
                  </div>
                  <div className="container-parrafo">
                    <span className="parrafo">Titular de Reserva: {resultHuespe?.Nombre} {resultHuespe?.Apellido}  </span>
                  </div>
                  <div className="container-parrafo">
                    <span className="parrafo">Abono: {change?.abono}</span>
                  </div>
          
                  <div className="container-parrafo">
                    <span className="parrafo">Tarifas: {global}</span>{" "}
                    <span> Tarifa sin impuestos </span>
                  </div>
          
                  <div className="container-parrafo">
                    <span className="parrafo">Telefono: {resultHuespe?.Celular}</span>
                  </div>
                  <div className="container-parrafo">
                    <span className="parrafo">Identificacion: {resultHuespe?.Num_documento} </span>
                  </div>
                  <div className="container-parrafo">
                    <span className="parrafo">Correo: {resultHuespe?.Correo}</span>
                  </div>
                </div>
                ...
                <div className="container-flex-entrada">
                  <span>Entrada:</span>
                  <span>Salida:</span>
                </div>
          
                <div className="container-flex-entrada">
                  <span className="title-entrada">{fechaOne}</span>
                  <span>{fechaTwo}</span>
                </div>
          
                <div className="container-flex-entrada one">
                  <span>Entrada:</span>
                  <span>Salida:</span>
                </div>
                ...
                <div className="container-flex-entrada">
                  <span>{findRoomOne?.nombre}</span>
                  <span>{change?.adultos}</span>
                  <span>{change?.niños}</span>
                </div>
                                                ...
                                                <input   type="checkbox" 
                                                    ...
                                                    checked={isChecked}/> Empresa
                                                            ...
                                                            <li>
                                                                ...
                                                                <span onClick={handClickPdf} >Comprobante</span>
                                                                </button>
                                                            </li> 
